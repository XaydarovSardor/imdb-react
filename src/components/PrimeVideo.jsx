    ...
    const movies = [
        {
            ...
            date: "2021-09-18",
            rating: 7.8,
            img: "https://images.unsplash.com/photo-1502139214985-d4d2ba06bcb0?auto=format&fit=crop&w=900&q=60"
        },
        {
            title: "Midnight Echo",
            date: "2020-11-02",
        ...
        },
        {
            ...
            date: "2022-02-14",
            rating: 8.1,
            img: "https://images.unsplash.com/photo-1509817316-c1f8a3f162f6?auto=format&fit=crop&w=900&q=60"
        },
        {
            title: "City of Dreams",
            date: "2018-06-08",
            rating: 7.5,
            img: "https://images.unsplash.com/photo-1497032628192-86f99bcd76bc?auto=format&fit=crop&w=900&q=60"
        },
        {
            title: "Echoes of Tomorrow",
            date: "2023-03-29",
            rating: 8.4,
            img: "https://images.unsplash.com/photo-1478720568477-152d9b164e26?auto=format&fit=crop&w=900&q=60"
        }
    ];
            ...
            <div className="container">
                ...
                <div className="flex mt-5 justify-between">
                    {movies.map((movie, index) => (
                        <div key={index} className="max-w-[190px] w-full bg-black text-white rounded-2xl overflow-hidden shadow-lg">
